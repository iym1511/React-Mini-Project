    ...
    return (  
        <div>
            ...
            <p onMouseEnter={(e)=>{
                ...
                // 관련 기능을 작성할수 있는 자바스크립트 작성 가능
                setOnMouse(true)
                // 이벤트 객체를 통해서 DOM 값을 가져올수 있다
                console.log(e.target)
                console.log("currentTarget",e.currentTarget)
                // 이벤트 객체를 통해서 가져온 DOM값을 자바스크립트에서 사용한
                // 방식으로 수정할수 있다
            ...
            style={ onMouse ? {color:"red"} : {color:"blue"}}
            ><span style={{fontWeight:"bold", color:"red"}}>SPAN마우스</span>
            마우스를 위로 올리세요:{onMouse ? "올라갔습니다" : "아직안올라감"}</p>
        </div>
    );
}
